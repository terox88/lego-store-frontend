            ...
            <form onSubmit={handleSubmit} className="form-grid">
                ...
                <div className="form-section">
                    ...
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            ...
                            <input name="setNumber" value={form.setNumber} onChange={handleChange} />
                        </div>
                    </div>
                ...
                <div className="form-section">
                    ...
                    <div className="form-row">
                        <div className="form-group">
                            ...
                            <input type="number" name="numberOfPieces" min="1" step="1"
                                   value={form.numberOfPieces} onChange={handleChange} />
                        </div>

                        <div className="form-group">
                            <label>Number of Boxes</label>
                            <input type="number" name="numberOfBoxes" min="1" step="1"
                                   value={form.numberOfBoxes} onChange={handleChange} />
                        </div>
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div className="form-row">
                        <div className="form-group">
                            ...
                            <input type="number" name="quantityInWarehouse" min="0" step="1"
                                   value={form.quantityInWarehouse} onChange={handleChange} />
                        </div>

                        <div className="form-group">
                            <label>Store Quantity</label>
                            <input type="number" name="quantityInStore" min="0" step="1"
                                   value={form.quantityInStore} onChange={handleChange} />
                        </div>
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div className="form-group">
                        ...
                        <input type="number" name="basePrice" min="0" step="0.01"
